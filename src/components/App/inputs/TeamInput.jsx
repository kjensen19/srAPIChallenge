  ...
  return (
    ...
    >
      <FormControl fullWidth>
        ...
        >
          <MenuItem value={1}>New Jersey Devils</MenuItem>
          <MenuItem value={2}>New York Islanders</MenuItem>
          <MenuItem value={3}>New York Rangers</MenuItem>
          <MenuItem value={4}>Philadelphia Flyers</MenuItem>
          <MenuItem value={5}>Pittsburgh Penguins</MenuItem>
          <MenuItem value={6}>Boston Bruins</MenuItem>
          <MenuItem value={7}>Buffalo Sabres</MenuItem>
          <MenuItem value={8}>Montréal Canadiens</MenuItem>
          <MenuItem value={9}>Ottowa Senators</MenuItem>
          <MenuItem value={10}>Toronto Maple Leafs</MenuItem>
          <MenuItem value={12}>Carolina Hurricanes</MenuItem>
          <MenuItem value={13}>Florida Panthers</MenuItem>
          <MenuItem value={14}>Tampa Bay Lightning</MenuItem>
          <MenuItem value={15}>Washington Capitals</MenuItem>
          <MenuItem value={16}>Chicago Blackhawks</MenuItem>
          <MenuItem value={17}>Detroit Red Wings</MenuItem>
          <MenuItem value={18}>Nashville Predators</MenuItem>
          <MenuItem value={19}>St. Louis Blues</MenuItem>
          <MenuItem value={20}>Calgary Flames</MenuItem>
          <MenuItem value={21}>Colorado Avalanche</MenuItem>
          <MenuItem value={22}>Edmonton Oilers</MenuItem>
          <MenuItem value={23}>Vancouver Canucks</MenuItem>
          <MenuItem value={24}>Anaheim Ducks</MenuItem>
          <MenuItem value={25}>Dallas Stars</MenuItem>
          <MenuItem value={26}>Los Angeles Kings</MenuItem>
          <MenuItem value={28}>San Jose Sharks</MenuItem>
          <MenuItem value={29}>Columbus Blue Jackets</MenuItem>
          <MenuItem value={30}>Minnesota Wild</MenuItem>
          <MenuItem value={52}>Winnipeg Jets</MenuItem>
          <MenuItem value={53}>Arizona Coyotes</MenuItem>
          <MenuItem value={54}>Vegas Golden Knights</MenuItem>
          <MenuItem value={55}>Seattle Kraken</MenuItem>
        </Select>
      </FormControl>
      <FormControl fullWidth>
